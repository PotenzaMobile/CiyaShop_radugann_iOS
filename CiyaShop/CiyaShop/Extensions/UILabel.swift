...
extension UILabel
{
    ...
    func setUpAvailabilityUI(color:UIColor,strAvailability:String,stock:Int) -> NSMutableAttributedString
    {
        ...
        let attributeString3 =  "\(stock) ".SetAvailableAttributedString(color: color, font: UIFont.appBoldFontName(size: fontSize12))
...
//        return attrStr
    ...
    func setPriceForItem(_ str: String) {
        ...
        var strHTML = str
        let strAtt = strHTML as NSString
...
//        return attrStr
    ...
    func setPriceForProductItem(str:String,isOnSale:Bool,product:JSON)
    {
        ...
        if(isOnSale && product["type"].stringValue != ProductType.grouped.rawValue && product["type"].stringValue != ProductType.variable.rawValue)
        {
            ...
            {
                var finalAttrStr = NSMutableAttributedString()
