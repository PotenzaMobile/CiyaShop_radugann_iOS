...
//        }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //            } else {
        //                cell.btnMovetoCart.removeTarget(self, action:  #selector(btnMovetoCartClicked(_:)), for: .touchUpInside)
        //            }
        //        } else {
        //            cell.btnMovetoCart.removeTarget(self, action:  #selector(btnMovetoCartClicked(_:)), for: .touchUpInside)
        //        }
...
//            showToast(message: getLocalizationString(key: "ItemAlreadyInCart"))
//        } else {
//            if let inStock = product["in_stock"].bool {
//                if inStock == true {
//                    addRemoveItemFromWishlist(product: product)
...
//                }
//            } else {
//                showToast(message: getLocalizationString(key: "OutOfStock"))
//            }
//        }
    }
