...
//func showAlert(messageStr:String ,viewController: UIViewController) -> Void {
//    let alert = UIAlertController(title: APP_NAME, message: messageStr, preferredStyle: UIAlertController.Style.alert);
//    alert.addAction(UIAlertAction(title: getLocalizationString(key: "OK"), style: .cancel, handler: nil))
//    keyWindow?.rootViewController!.present(alert, animated: true, completion: nil)
//}


//func showAlertWithConfirmation(messageStr:String ,viewController: UIViewController,onConfirm: @escaping () -> Void) -> Void {
//    let alert = UIAlertController(title: APP_NAME, message: messageStr, preferredStyle: UIAlertController.Style.alert);
//    
//    
//    alert.addAction(UIAlertAction(title: getLocalizationString(key: "Yes"), style: .default, handler: { (action) in
//        onConfirm()
//    }))
//    
//    alert.addAction(UIAlertAction(title: getLocalizationString(key: "No"), style: .cancel, handler: nil))
//
...
//    customAlert.transform = CGAffineTransform(scaleX: 0.01, y: 0.01)
//    customAlert.blurView.backgroundColor = UIColor.black.withAlphaComponent(0.0)
//    UIView.animate(withDuration: 0.3, animations: {
//        customAlert.transform = .identity
//    }) { (animated) in
//        customAlert.blurView.backgroundColor = UIColor.black.withAlphaComponent(0.7)
//    }
...
//    }
    ...
    if UIApplication.shared.responds(to: #selector(getter: UIApplication.currentUserNotificationSettings)) {
        ...
        if types.rawValue & UIRemoteNotificationType.alert.rawValue != 0 {
            isEnabled = true
        } else {
            isEnabled = false
        }
