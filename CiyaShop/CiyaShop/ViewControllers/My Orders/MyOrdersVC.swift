...
//
//        tblMyOrders.register(UINib(nibName: "MyOrderCell", bundle: nil), forCellReuseIdentifier: "MyOrderCell")
//
//        tblMyOrders.reloadData()
//
//        tblMyOrders.contentInset = UIEdgeInsets(top: 0, left: 0, bottom: 20, right: 0)
...
//        cell.btnDetails.addTarget(self, action: #selector(navigateToOrderDetail), for: .touchUpInside)
//
//        return cell
//
//    }
