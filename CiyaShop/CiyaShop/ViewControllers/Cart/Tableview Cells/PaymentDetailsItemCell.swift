...
//    @IBOutlet weak var lblShippingValue: UILabel!
    ...
    func setupCell() {
        ...
        self.lblSubTotalTitle.text = getLocalizationString(key: "Price")
...
//        self.lblShippingTitle.textColor = grayTextColor//secondaryColor
//
//        self.lblShippingValue.font = UIFont.appBoldFontName(size: fontSize12)
//        self.lblShippingValue.textColor = grayTextColor//secondaryColor
        ...
        self.btnContinueCheckout.setTitle(getLocalizationString(key: "Continue"), for: .normal)
    ...
    func setPaymentDetails() {
        ...
        for item in arrayData {
            ...
            /*if(item["advanced_qty_step"].intValue > 1)
            {
                subTotal = subTotal + Double(item["price"].floatValue).roundToDecimal() * Double((item["qty"].floatValue/item["advanced_qty_step"].floatValue)).roundToDecimal()
