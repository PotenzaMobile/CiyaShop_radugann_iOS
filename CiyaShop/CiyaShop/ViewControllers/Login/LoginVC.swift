...
class LoginVC: UIViewController,GIDSignInDelegate, ASAuthorizationControllerPresentationContextProviding {
    ...
    override func viewDidLoad() {
        ...
        //        self.txtLogin.text = "tushar.katariya@potenzaglobalsolutions.com"
        //        self.txtPassword.text = "1(OD4ksNghWzrBhQTc"
        
        //        self.txtLogin.text = "nimesh.patel@potenzaglobalsolutions.com"
        //        self.txtPassword.text = "potenza@123"
    }
    ...
    func setThemeColors() {
        ...
        //        txtLogin.attributedPlaceholder = NSAttributedString(string: getLocalizationString(key: "Email"), attributes: [NSAttributedString.Key.foregroundColor: secondaryColor.withAlphaComponent(0.5)])
        ...
        //        txtPassword.attributedPlaceholder = NSAttributedString(string: getLocalizationString(key: "Password"), attributes: [NSAttributedString.Key.foregroundColor: secondaryColor.withAlphaComponent(0.5)])
    ...
    @IBAction func btnForgotPasswordClicked(_ sender: Any) {
        ...
        //            forgotPasswordVC.modalTransitionStyle = UIModalTransitionStyle.coverVertical
        //
    ...
    func syncWishlist() {
        ...
        //         {"sync_list":[{"product_id":"348","user_id":"1","quantity":1,"wishlist_name":""}],"user_id":"1"}
