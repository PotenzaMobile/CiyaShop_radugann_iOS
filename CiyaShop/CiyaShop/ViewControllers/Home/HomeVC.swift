...
//    var arrSpecialDeals : Array = Array<JSON>()
    ...
    // for header hide show
//    let minimumConstantValue = CGFloat(-44)
//    var range: Range<CGFloat> = (-44..<0)
    ...
    func setupCollectionCells()  {
        ...
        for productViewOrder in arrProductViewOrder {
            ...
            if "special_deal_products" == productOrder["name"] {
                ...
                //            else if "recent_products" == productOrder["name"] {
                //                if let recentProducts = (dictProductCarousel["recent_products"] as! JSON)["products"].array {
...
//                        showAlert(messageStr: message, viewController: self)
//                    } else {
//                        showAlert(messageStr: getLocalizationString(key: "technicalIssue")!, viewController: self)
//                    }
