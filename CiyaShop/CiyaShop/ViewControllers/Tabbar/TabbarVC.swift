...
//            isTeraWalletActive = true
        ...
        //for static use
//        isRTL = false
//        MCLocalization.sharedInstance.language = "en-US"
...
//        if let count = tabController.tabBar.items?.count {
//            if count > 0 {
//                for i in 0...(count-1) {
//                    if i == 0 {
//                        tabController.tabBar.items?[i].title = getLocalizationString(key: "Search")
//                    } else if i == 1 {
//                        tabController.tabBar.items?[i].title = getLocalizationString(key: "Cart")
//                    } else if i == 3 {
//                        tabController.tabBar.items?[i].title = getLocalizationString(key: "Account")
//                    } else if i == 4 {
//                        tabController.tabBar.items?[i].title = getLocalizationString(key: "Wishlist")
//                    }
//                }
//            }
//        }
...
//        var whatsappUrl3 = appURL
//        whatsappUrl3 = (CFBridgingRelease(CFURLCreateStringByAddingPercentEscapes(nil, whatsappUrl3 as CFString, nil, !*'();:@&=+$,/?%#[]", CFStringBuiltInEncodings.UTF8)) as? String) ?? "" as! String
...
extension TabbarVC : UITabBarDelegate
{
    ...
    {
        print("Selected didSelect viewController")
